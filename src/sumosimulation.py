    ...
    def run(self):
        ...
        while (
            ...
            if self.steps % 10000 == 0:
                ...
                start_time = time.time()
            if ((self.args.simulation == "wroclaw" and simulation_time > 200) or (self.args.simulation == "wielun" and simulation_time > 35)):
                print(
                    self.steps,
                    "steps took more than 35 seconds, exiting with fitness 9999",
                )
                self.sim_step()
